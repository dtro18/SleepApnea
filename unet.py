...
complete_folder = 'D:\SleepApneaPtData\set_1_complete'
incomplete_folder = 'D:\SleepApneaPtData\set_1_masked'

# Image dimensions (you can change it depending on your dataset)
img_height = 256
img_width = 256
channels = 3  # Use 1 for grayscale, 3 for RGB
...
def unet(input_size=(256, 256, 3)):
    ...
    outputs = layers.Conv2D(3, (1, 1), activation='sigmoid')(c9)  # Change channels as per your output
